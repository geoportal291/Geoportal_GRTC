...
import './CanteraImageThumbnails.css';

const CanteraImageThumbnails = ({ imagenes, onContainerClick }) => {
        ...
        <div className="thumbnail-section-container" onClick={onContainerClick} style={{ cursor: 'pointer' }}>
            ...
            {hasImages ? (
                ...
                <div className="no-images-message">
                    <p>No hay imágenes en esta cantera</p>
                </div>
            )}
        </div>
    );
...
export default CanteraImageThumbnails;
