...
const DetalleMuroView = ({ muro, images, route, onCloseDetail }) => {
    ...
    const handleExportPDF = async () => {
        ...
        try {
            ...
            const titleId = muro.clase || muro.id_muro;
            // Center title
            pdf.text(`Muro: ${titleId}`, pdfWidth / 2, cursorY, { align: 'center' });
            cursorY += 10;
