...
const FormularioSenalPreventivaView = ({ formData, handleInputChange }) => {
    return (
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 calc(50% - 7.5px)' }}>
                    ...
                    >
                        ...
                        <option value="Señal Preventiva">Señal Preventiva</option>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 calc(50% - 7.5px)' }}>
                    ...
                    <input
                        ...
                        onChange={handleInputChange}
                        placeholder="Ej: Señal Preventiva"
                        style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '5px' }}
                    />
                </div>
...
export default FormularioSenalPreventivaView;
