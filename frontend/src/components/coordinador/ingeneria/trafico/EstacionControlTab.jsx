  ...
  return (
    <div className="estacion-control-tab-wrapper">
                ...
                <div className="stations-grid" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'flex-start', overflowX: 'auto', paddingBottom: '10px', width: '100%', gap: '10px' }}>
                  {Object.keys(stationData).map((stationId) => (
                    ...
                    >
                      ...
                      {stationData[stationId].info && stationData[stationId].info.imagenes && stationData[stationId].info.imagenes.filter(img => img.source_type === 'estacion_control').length > 0 && (() => {
                        const sortedImages = [...stationData[stationId].info.imagenes.filter(img => img.source_type === 'estacion_control')].sort((a, b) => {
      ...
      <ImageFileExplorerModal
        ...
        data={stationData}
        allowedSourceTypes={['estacion_control']}
...
export default EstacionControlTab;