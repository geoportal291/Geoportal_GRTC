...
import DetalleSenalPreventivaView from './DetalleSenalPreventivaView';
import './ListaSenalesInformativasModal.css'; // Reusing CSS

const ListaSenalesPreventivasModal = ({ show, onClose, senalesData, graphicsImages, initialSelection }) => {
    ...
    return (
        <div className="lista-senales-modal-overlay">
            <div className="lista-senales-modal-content">
                ...
                {!selectedSenal ? (
                    <>
                        <h2 className="lista-senales-modal-title" style={{ textAlign: 'center' }}>Lista de Señales Preventivas</h2>
...
export default ListaSenalesPreventivasModal;
