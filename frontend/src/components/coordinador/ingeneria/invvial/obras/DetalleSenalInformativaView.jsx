...
const DetalleSenalInformativaView = ({ senalInformativa: senal, images, route, onCloseDetail }) => {
    ...
    const handleExportPDF = async () => {
        ...
        try {
          ...
          `,
            ...
            // Center title
            pdf.text(`Señal Informativa: ${titleId}`, pdfWidth / 2, cursorY, { align: 'center' });
            cursorY += 10;
        ...
        <div style={{
            ...
            <div ref={modalRef} style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #eee', paddingBottom: '2px' }}>
                    <h2 style={{ margin: 0, color: '#333', fontSize: '1.1rem' }}>Señal Informativa: {senal.codigo || 'Sin Código'}</h2>
                ...
                <div style={{ display: 'flex', gap: '10px', flex: 1 }}>
                    ...
                    <div style={{ flex: 2, display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        ...
                        <div ref={mapRef} style={{
                            ...
                            <MiniMap alcantarilla={senal} route={null} />
                        </div>
...
export default DetalleSenalInformativaView;
