...
import ListaSenalesPreventivasModal from './obras/ListaSenalesPreventivasModal';
...
const SenalesPreventivas = ({ senalesData, graphicsImages, canUpload, showModal, onElementSelect, canComment, projectId }) => {
    ...
    const handleSenalClick = useCallback((senal) => {
        ...
        Swal.fire({
            ...
            title: 'Señal Preventiva Seleccionada',
    ...
    const handleExport = async (selectedItems, format) => {
        ...
        Swal.fire('Exportar', 'Funcionalidad en desarrollo para Señales Preventivas.', 'info');
    ...
    const formatProgresiva = (prog) => {
        if (prog === null || prog === undefined) return '';
        const num = Number(prog);
        if (isNaN(num)) return prog;
                                    ...
                                    <div>
                                        ...
                                        <div style={{ border: '1px solid #e2e8f0', borderRadius: '8px', marginBottom: '10px', fontSize: '12px', overflow: 'hidden' }}>
                                            <div style={{ padding: '12px' }}>
                                                ...
                                                <p style={{ margin: '0 0 5px 0' }}><strong>Progresiva:</strong> {formatProgresiva(selectedSenal.progresiva)}</p>
...
export default SenalesPreventivas;
