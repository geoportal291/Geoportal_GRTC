            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px' }}>
                {modalViewMode === 'edit' && (
                    <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 calc(50% - 7.5px)' }}>
                        <label htmlFor="id_baden" style={{ marginBottom: '5px', fontWeight: 'bold', fontSize: '0.9em', color: '#333' }}>ID Badén:</label>
                        <input type="text" id="id_baden" name="id_baden" value={formData.id_baden ?? ''} disabled style={{ padding: '10px', border: '1px solid #ddd', borderRadius: '5px', backgroundColor: '#f0f0f0', color: '#666' }} />
                    </div>
                )}
                <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 calc(50% - 7.5px)' }}>
                    <label htmlFor="codigo" style={{ marginBottom: '5px', fontWeight: 'bold', fontSize: '0.9em', color: '#333' }}>N de badén:</label>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 calc(50% - 7.5px)' }}>
                    <label htmlFor="longitud_baden" style={{ marginBottom: '5px', fontWeight: 'bold', fontSize: '0.9em', color: '#333' }}>Longitud Badén:</label>
                    <input type="number" step="any" id="longitud_baden" name="longitud_baden" value={formData.longitud_baden ?? ''} onChange={handleChange} style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '5px' }} />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 calc(50% - 7.5px)' }}>
...
export default FormularioBadenView;
