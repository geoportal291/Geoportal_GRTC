...
const FormularioSenalInformativaView = ({ formData, handleInputChange }) => {
    return (
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 calc(50% - 7.5px)' }}>
                    ...
                    >
                        ...
                        <option value="Señal Informativa">Señal Informativa</option>
                        <option value="Hito Kilométrico">Hito Kilométrico</option>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 calc(50% - 7.5px)' }}>
                    ...
                    <input
                        ...
                        onChange={handleInputChange}
                        placeholder="Ej: Hito kilométrico"
                        style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '5px' }}
                    />
                </div>
...
export default FormularioSenalInformativaView;
