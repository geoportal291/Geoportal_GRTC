-- Actualiza la config_calculos de Granulometría (ID=1) para usar la nueva función get_nested_value y solucionar el bug de lectura de datos.
UPDATE tipo_ensayo
SET config_calculos = $$
{
    "version": "9.0",
    ...
    "steps": [
        ...
        { "type": "expression", "output": "results.granulometria.coef_curvatura", "condition": "vars.d10_safe > 0 && vars.d60_safe > 0", "expression": "pow(vars.d30_safe, 2) / (vars.d10_safe * vars.d60_safe)" }
    ]
}
$$::jsonb
WHERE id = 1;