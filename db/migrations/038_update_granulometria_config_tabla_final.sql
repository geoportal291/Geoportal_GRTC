-- Actualiza la config_tabla de Granulometría (ID=1) para configurar las filas 'fondo' y 'total'.
UPDATE tipo_ensayo
SET config_tabla = $$
{
  "tables": {
      ...
      "rows": [
        ...
        {"tamiz": "N° 200","key": "n200","mm": 0.075},
        {
            ...
            "cell_overrides": {
                "retenido": {
                    "type": "calculated",
                    "result_config": { "key": "general_fields.peso_fraccion_fina", "scope": "global" }
                },
        ...
        },
        {
            ...
            "cell_overrides": {
                ...
                "porc_retenido": {
                    "type": "calculated",
                    "result_config": { "key": "granulometria.porcRet.total", "scope": "global" }
                },
                "porc_acum": {
                    "type": "calculated",
                    "result_config": { "key": "granulometria.acum.total", "scope": "global" }
                },
                "porc_pasa": {
                    "type": "calculated",
                    "result_config": { "key": "granulometria.pasa.total", "scope": "global" }
                }
            }
        }
      ],
