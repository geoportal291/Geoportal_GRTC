-- Actualiza la configuración de CÁLCULOS para el ensayo de Granulometría (ID=1) con pasos de depuración para vars.d_safe.
UPDATE tipo_ensayo
SET config_calculos = '{
    "version": "8.3",
    "vars": {
    ...
    "steps": [
        ...
        {
          "type": "expression",
          "comment": "DEBUG: d10_safe",
          "output": "results.debug_d10_safe",
          "expression": "vars.d10_safe"
        },
        {
          "type": "expression",
          "comment": "DEBUG: d30_safe",
          "output": "results.debug_d30_safe",
          "expression": "vars.d30_safe"
        },
        {
          "type": "expression",
          "comment": "DEBUG: d60_safe",
          "output": "results.debug_d60_safe",
          "expression": "vars.d60_safe"
        },
