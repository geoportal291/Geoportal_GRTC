...
SET config_tabla = $$
{
  "granulometria": {
    "headers": [
      { "key": "tamiz", "label": "Tamiz", "type": "static" },
      { "key": "mm", "label": "mm", "type": "static" },
      { "key": "retenido", "label": "Peso Retenido (g)", "type": "input" },
      { "key": "porc_retenido", "label": "% Ret.", "type": "calculated" },
      { "key": "porc_acum", "label": "% Acum.", "type": "calculated" },
      { "key": "porc_pasa", "label": "% Pasa", "type": "calculated" }
    ],
    "rows": [
...
$$::jsonb
WHERE codigo = 'GRA'; -- Asumiendo que 'GRA' es el código para Granulometría
