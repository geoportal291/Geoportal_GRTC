-- Actualiza la configuración de la tabla para el ensayo de Granulometría (ID=1)
UPDATE tipo_ensayo
SET config_tabla = '{
  "tables": {
    "granulometria": {
      "rows": [
        ...
        {"tamiz": "<200","key": "fondo","mm": null,"cell_overrides": {"retenido": {"type": "calculated","result_config": {"key": "granulometria.retenidoMenor200","scope": "global"}}}},
        {"tamiz": "Total","key": "total","mm": null,"porc_acum": {"type": "static","static_text": ""},"porc_pasa": {"type": "static","static_text": ""},"porc_retenido": {"type": "static","static_text": ""},"cell_overrides": {"retenido": {"type": "calculated","result_config": {"key": "granulometria.totalRetenido","scope": "global"}}}}
      ],
      "layout": {"width": "100%"},
      "headers": [
  ...
  "general_fields": {
    ...
    "fields": [
      ...
      {"key": "peso_fraccion_fina","type": "number","label": "Peso Fracción Fina"},
