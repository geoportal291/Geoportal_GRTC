-- Actualiza la configuración de CÁLCULOS para Granulometría (ID=1) con pasos de depuración para el cálculo de coef_curvatura.
UPDATE tipo_ensayo
SET config_calculos = $$
{
    "version": "8.5-debug",
    ...
    "steps": [
        ...
        {
            "text": "4. DEBUG: Descomponer cálculo de Coef. Curvatura",
            "type": "comment"
        },
        {
            "type": "expression",
            "comment": "DEBUG 1: Square d30",
            "output": "vars.debug_d30_squared",
            "expression": "pow(vars.d30_safe, 2)"
        },
        {
            "type": "expression",
            "comment": "DEBUG 2: Multiply d10 and d60",
